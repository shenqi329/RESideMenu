...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 1:
            #if 1
        {
            UINavigationController *naviController = (UINavigationController*)self.sideMenuViewController.contentViewController;
            DEMOFirstViewController *first = (DEMOFirstViewController*)naviController.viewControllers.firstObject;
            [first pushViewController:nil];
            //[self.sideMenuViewController hideMenuViewController];
        }
            #else
