    ...
    switch (gestureRecognizer.state) {
            ...
            if (_operation == CEInteractionOperationPop) {
                ...
                if ((self.popOnRightToLeft && rightToLeftSwipe) ||
                    ...
                    if ([_viewController isKindOfClass:[UINavigationController class]]) {
                        UINavigationController *nav = (UINavigationController *)_viewController;
        ...
        case UIGestureRecognizerStateChanged: {
            if (self.interactionInProgress) {
                ...
                CGFloat progress = [gestureRecognizer translationInView:_viewController.view].x / [UIScreen mainScreen].applicationFrame.size.width;
                progress = MIN(1.0, MAX(0.0, progress));
                [self updateInteractiveTransition:progress];
                _shouldCompleteTransition = (progress > 0.5);
//                CGFloat fraction = fabsf(translation.x / [UIScreen mainScreen].applicationFrame.size.width);
